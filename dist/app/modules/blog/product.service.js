...
const createProductIntoDB = (productData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.Product.create(productData);
    return result;
});
const getAllProductsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const products = yield blog_model_1.Product.find(filterOptions);
    return products;
});
const getOneProductFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.Product.findById(id);
    return result;
});
const updateProductFromDB = (id, updatedProductData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield blog_model_1.Product.findByIdAndUpdate(id, modifiedUpdatedData, {
        new: true,
        runValidators: true,
    });
    return result;
...
const deleteOneProductFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield blog_model_1.Product.findByIdAndDelete(id);
    return result;
});
const duplicateProductFromDB = (id, duplicateProductData) => __awaiter(void 0, void 0, void 0, function* () {
    const existingProduct = yield blog_model_1.Product.findById(id);
    if (!existingProduct) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, 'Product not found');
    }
    const productObject = existingProduct.toObject();
    // Duplicate the product by creating a new
    const duplicatedProduct = new blog_model_1.Product(Object.assign(Object.assign(Object.assign({}, productObject), { _id: new mongoose_1.default.Types.ObjectId(), name: `${existingProduct.name}` }), duplicateProductData));
...
const bulkDeletedProductFromDB = (productsId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield blog_model_1.Product.deleteMany({ _id: { $in: productsId } });
